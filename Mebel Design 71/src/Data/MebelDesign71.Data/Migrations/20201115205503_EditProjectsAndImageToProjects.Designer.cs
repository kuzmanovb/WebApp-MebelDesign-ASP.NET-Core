...
namespace MebelDesign71.Data.Migrations
{
    ...
    [Migration("20201115205503_EditProjectsAndImageToProjects")]
    partial class EditProjectsAndImageToProjects
    {
            ...
            modelBuilder.Entity("MebelDesign71.Data.Models.ImageToProject", b =>
                {
                    ...
                    b.HasOne("MebelDesign71.Data.Models.Project", "Project")
                        .WithOne("Image")
                        .HasForeignKey("MebelDesign71.Data.Models.ImageToProject", "ProjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
